...
book_schema = BookSchema(exclude=['created_at', 'updated_at', 'is_approved', 'stock_quantity'])
books_schema = BookSchema(many=True, exclude=['created_at', 'updated_at', 'is_approved', 'stock_quantity'])
